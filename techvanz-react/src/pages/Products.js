...
const Products = () => {
  return (
    <div className="max-w-6xl mx-auto space-y-12 px-4 md:px-0 font-sans">
      <h1 className="text-4xl font-extrabold text-blue-900 mb-8 text-center tracking-wide">Products</h1>

      <section className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <article className="space-y-5 text-center transition-transform transform hover:scale-105 hover:shadow-lg rounded-lg p-4">
          <img
            ...
            loading="lazy"
          />
          <h3 className="text-xl font-semibold text-blue-900 mt-4">TAB project POS system</h3>
        ...
        <article className="space-y-5 text-center transition-transform transform hover:scale-105 hover:shadow-lg rounded-lg p-4">
          <img
            ...
            loading="lazy"
          />
          <h3 className="text-xl font-semibold text-blue-900 mt-4">Real-time order tracking</h3>
        ...
        <article className="space-y-5 text-center transition-transform transform hover:scale-105 hover:shadow-lg rounded-lg p-4">
          <img
            ...
            loading="lazy"
          />
          <h3 className="text-xl font-semibold text-blue-900 mt-4">Digital customer engagement</h3>
      ...
      <section className="max-w-6xl mx-auto space-y-10 mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
          <div className="border rounded-lg p-8 shadow hover:shadow-xl transition-transform transform hover:scale-105">
            <img
              ...
              loading="lazy"
            />
            <h3 className="text-xl font-semibold text-blue-900 mb-3">TAB project - cloud-based POS system</h3>
            ...
            <a href="/products" className="text-blue-700 hover:underline inline-block mt-3 font-medium">Read more</a>
          </div>
          <div className="border rounded-lg p-8 shadow hover:shadow-xl transition-transform transform hover:scale-105">
            <img
              src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=800&q=80"
              ...
              loading="lazy"
            />
            <h3 className="text-xl font-semibold text-blue-900 mb-3">Real-time order tracking</h3>
          ...
          <div className="border rounded-lg p-8 shadow hover:shadow-xl transition-transform transform hover:scale-105">
            <img
              ...
              loading="lazy"
            />
            <h3 className="text-xl font-semibold text-blue-900 mb-3">Digital customer engagement via QR codes</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-8">
          <div className="text-center space-y-6">
            <img
              ...
              loading="lazy"
            />
            <h3 className="text-xl font-semibold text-blue-900">Multi-tenant store management</h3>
            <p className="text-gray-700">Effortlessly manage multiple store locations in one platform.</p>
            <a href="/products" className="text-blue-700 hover:underline font-medium">Learn more</a>
          </div>
          <div className="text-center space-y-6">
            <img
              src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=800&q=80"
              ...
              loading="lazy"
            />
            <h3 className="text-xl font-semibold text-blue-900">Real-time order tracking</h3>
